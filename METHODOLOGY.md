...
**각 Phase마다** `GitMini/docs/` 아래 **통합 문서 하나**를 둔다. **작성 주체는 AI**이다.

- **파일명**: `docs/PHASE1.md`, `docs/PHASE2.md`, `docs/PHASE3.md`, …
- **구성**: 한 문서에 **계획 · 과정 · 종료**를 모두 기록한다.
  - **계획**: 해당 Phase의 목표, 작업 목록, 결과물 정의 (DESIGN.md 기준)
  - **과정**: Step별 진행 내용, 생성/수정된 파일, 주요 결정·이슈
  - **종료**: 검증 결과(빌드/테스트), 완료 요약, 다음 Phase 시 주의사항
- **시점**:
  - Phase 착수 전: AI가 해당 Phase 문서를 만들고 **계획** 섹션을 채운다.
  - Phase 진행 중: **과정**을 Step 단위로 보완한다.
  - Phase 종료 시: **종료** 섹션을 채우고, 필요 시 과정을 최종 정리한다.

Phase별 계획·과정·종료가 한 문서에 모여 있도록 AI가 유지·갱신한다.
...
| **Phase 통합 문서** | AI가 각 Phase마다 `docs/PHASE N.md`에 계획·과정·종료를 기록 |
